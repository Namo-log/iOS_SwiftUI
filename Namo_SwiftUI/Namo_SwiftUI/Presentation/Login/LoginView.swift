        ...
        if appState.isLogin {
            ...
            VStack {
                ...
                VStack {
                    ...
                    LoginBtn(textContent: "네이버 로그인", textColor: .white, btnBackgroundColor: "#03C75A", btnImage: "ic_login_naver 1")
                    .padding(.top, 22)
                    
                    LoginBtn(textContent: "Apple 로그인", textColor: .white, btnBackgroundColor: "#000000", btnImage: "ic_login_apple")
                    .padding(.top, 22)
                }
                .padding(.bottom, 50)
            }
