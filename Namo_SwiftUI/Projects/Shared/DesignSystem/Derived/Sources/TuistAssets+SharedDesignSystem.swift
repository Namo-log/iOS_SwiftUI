...
public enum SharedDesignSystemAsset: Sendable {
  ...
  public static let accentColor = SharedDesignSystemColors(name: "AccentColor")
    ...
    public static let lightBlue = SharedDesignSystemColors(name: "LightBlue")
    public static let lightGray = SharedDesignSystemColors(name: "LightGray")
    public static let lightGreen = SharedDesignSystemColors(name: "LightGreen")
    public static let lime = SharedDesignSystemColors(name: "Lime")
    public static let magenta = SharedDesignSystemColors(name: "Magenta")
    public static let namoBlue = SharedDesignSystemColors(name: "NamoBlue")
    public static let namoOrange = SharedDesignSystemColors(name: "NamoOrange")
    public static let namoPink = SharedDesignSystemColors(name: "NamoPink")
    public static let namoYellow = SharedDesignSystemColors(name: "NamoYellow")
    public static let orange = SharedDesignSystemColors(name: "Orange")
    ...
    public static let icCheckPlace = SharedDesignSystemImages(name: "ic_check_place")
    ...
    public static let icCrown = SharedDesignSystemImages(name: "ic_crown")
    ...
    public static let icFavColor = SharedDesignSystemImages(name: "ic_favColor")
    public static let icFavColorInvalid = SharedDesignSystemImages(name: "ic_favColor_invalid")
    public static let icFavColorValid = SharedDesignSystemImages(name: "ic_favColor_valid")
    ...
    public static let icInfoWindow = SharedDesignSystemImages(name: "ic_info_window")
    public static let icInfoWindowTail = SharedDesignSystemImages(name: "ic_info_window_tail")
    ...
    public static let icSearchGray = SharedDesignSystemImages(name: "ic_search_gray")
