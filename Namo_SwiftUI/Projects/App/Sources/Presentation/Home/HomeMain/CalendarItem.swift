			...
			VStack(alignment: .leading, spacing: 4) {
				if date.isToday {
					Text("\(date.day)")
						...
						.background(
							Circle()
								.fill((date.isFocusYearMonth ?? false) ? Color(asset: SharedDesignSystemAsset.Assets.mainOrange) : Color(asset: SharedDesignSystemAsset.Assets.mainOrange).opacity(0.5))
