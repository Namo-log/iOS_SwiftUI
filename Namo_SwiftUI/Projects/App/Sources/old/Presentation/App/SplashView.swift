...
//                ZStack {            // 스플래시 화면
//                    
//					LinearGradient(gradient: Gradient(colors: [Color(hex: 0xe59744), Color(asset: SharedDesignSystemAsset.Assets.mainOrange)]), startPoint: .topLeading, endPoint: .bottomTrailing)
//					
