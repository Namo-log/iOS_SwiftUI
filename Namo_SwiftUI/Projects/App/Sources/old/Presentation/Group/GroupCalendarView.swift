	...
	private var header: some View {
		HStack(spacing: 0) {
			...
			Button(action: {
				...
				Image(asset: SharedDesignSystemAsset.Assets.icMoreVertical)
			})
		}
		.padding(.top, 15)
		.padding(.leading, 20)
				...
				VStack(spacing: 0) {
					HStack {
						...
						Button(action: {
							...
							Image(asset: SharedDesignSystemAsset.Assets.icPencil)
						})
					}
					.padding(.bottom, 20)
					...
					HStack(spacing: 0) {
						...
						Button(action: {
							...
							Image(asset: SharedDesignSystemAsset.Assets.btnCopy)
						})
						.padding(.horizontal, 12)
					}
					.frame(height: 40)
