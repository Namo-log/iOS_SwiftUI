...
//        VStack {
//            HStack {
//				Image(asset: agreeVM.state.required1 && agreeVM.state.required2 ? SharedDesignSystemAsset.Assets.isSelectedTrue : SharedDesignSystemAsset.Assets.isSelectedFalse)
//                    .resizable()
