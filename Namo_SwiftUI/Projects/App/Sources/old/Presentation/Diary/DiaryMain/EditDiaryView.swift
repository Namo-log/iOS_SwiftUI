            ...
            VStack(alignment: .center) {
                    ...
                    ZStack(alignment: .topLeading) {
                        ...
                        if self.memo.isEmpty {
                            TextEditor(text: $placeholderText)
                                ...
                                .foregroundColor(Color(asset: SharedDesignSystemAsset.Assets.textPlaceholder))
                                .disabled(true)
                                .padding(.leading, 20)
                                .padding(.top, 5)
                                .padding(.bottom, 5)
                        ...
                        TextEditor(text: $memo)
                            .font(.pretendard(.medium, size: 15))
                            .foregroundColor(Color(asset: SharedDesignSystemAsset.Assets.mainText))
                ...
                if !appState.isPersonalDiary {
                    ...
                    NavigationLink(destination: EditMoimDiaryView(activities: diaryState.currentMoimDiaryInfo.moimActivityDtos ?? [], info: info, moimUser: diaryState.currentMoimDiaryInfo.getMoimUsers())) {
                        BlackBorderRoundedView(text: "모임 기록 보러가기", image: Image(asset: SharedDesignSystemAsset.Assets.icDiary), width: 192, height: 40)
                    }
                    .padding(.bottom, 25)
                }
                ...
                if appState.isPersonalDiary {
                    ...
                    if images.count < 3 {
                        ...
                        PhotosPicker(selection: $pickedImageItems, maxSelectionCount: photosLimit - images.count, selectionBehavior: .ordered) {
                            Image(asset: SharedDesignSystemAsset.Assets.btnAddImg)
                                .resizable()
                                .frame(width: 100, height: 100)
