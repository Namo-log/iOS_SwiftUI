            ...
            VStack(spacing: 0) {
                ...
                HStack(alignment: .top, spacing: 0) {
                    TextField(
                        "\(activity.name)",
                        text: $name,
                        prompt: Text("활동 \(index+1)").foregroundColor(Color(asset: SharedDesignSystemAsset.Assets.textPlaceholder))
                    )
                    ...
                    HStack() {
                        Text("총 \(activity.money)원")
                            ...
                            .foregroundStyle(Color(asset: SharedDesignSystemAsset.Assets.mainText))
						Image(asset: SharedDesignSystemAsset.Assets.rightChevronLight)
                    }
                    .onTapGesture {
            ...
            if isAddingViewVisible {
                Button {
                    ...
                    Rectangle()
                        ...
                        .overlay {
							Image(asset: SharedDesignSystemAsset.Assets.icTrashWhite)
                                .resizable()
