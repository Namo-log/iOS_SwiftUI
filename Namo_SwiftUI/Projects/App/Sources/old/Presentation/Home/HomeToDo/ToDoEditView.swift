...
struct ToDoEditView: View {
	...
	@State var categoryColor: Color = Color(asset: SharedDesignSystemAsset.Assets.mainOrange)
                ...
                ScrollView {
                    VStack {
                        ...
                        TextField("일정 이름", text: $scheduleState.currentSchedule.name)
							...
							.foregroundStyle(scheduleState.isCurrentScheduleIsGroup ? Color(asset: SharedDesignSystemAsset.Assets.textDisabled) : Color(asset: SharedDesignSystemAsset.Assets.mainText))
        ...
        var body: some View {
            Button(action: {
                ...
                Text(buttonText)
					...
					.foregroundStyle(self.isOn ? Color(asset: SharedDesignSystemAsset.Assets.mainOrange) : Color(asset: SharedDesignSystemAsset.Assets.mainText))
                    .background(
                        RoundedRectangle(
                            cornerRadius: 20,
                            style: .continuous
                        )
						.stroke(self.isOn ? Color(asset: SharedDesignSystemAsset.Assets.mainOrange) : Color(asset: SharedDesignSystemAsset.Assets.mainText), lineWidth: self.isOn ? 2 : 1)
                    )
            }
        }
    }
