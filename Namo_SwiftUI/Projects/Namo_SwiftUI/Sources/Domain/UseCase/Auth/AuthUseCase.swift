                ...
                UserApi.shared.loginWithKakaoTalk { [weak self] (oauthToken, error) in
                    ...
                    if let error = error {
                        ...
                        Task {
                            ...
                            let result: BaseResponse<SignInResponseDTO>? = await self?.authRepository.signIn(kakaoToken: SocialSignInRequestDTO(accessToken: kakaoAccessToken, socialRefreshToken: kakaoRefreshToken))
                ...
                UserApi.shared.loginWithKakaoAccount { (oauthToken, error) in
                    ...
                    if let error = error {
                        ...
                        Task {
                            ...
                            print("[Interactor] namoServerTokens: \(String(describing: namoServerTokens))")
...
extension AuthUseCase: NaverThirdPartyLoginConnectionDelegate {
    ...
    func oauth20ConnectionDidFinishRequestACTokenWithAuthCode() {
        ...
        Task {
            ...
            let result: BaseResponse<SignInResponseDTO>? = await self.authRepository.signIn(naverToken: SocialSignInRequestDTO(accessToken: naverAccessToken, socialRefreshToken: naverRefreshToken))
...
extension AuthUseCase: ASAuthorizationControllerDelegate, ASWebAuthenticationPresentationContextProviding {
