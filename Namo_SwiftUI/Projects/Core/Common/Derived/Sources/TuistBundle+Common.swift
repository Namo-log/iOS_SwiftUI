...
/// Since Common is a static framework, the bundle containing the resources is copied into the final product.
static let module: Bundle = {
    let bundleName = "Common_Common"
    var candidates = [
    ...
    fatalError("unable to find bundle named Common_Common")
}()
